...
import augurForgeLogo from '../../c7d6380c-a662-4b5a-8c89-e8b013511cd7.png';
...
export function App() {
  ...
  const insightTabs: { id: InsightTab; label: string; meta: string }[] = [
    ...
    { id: 'trace', label: 'Trace', meta: building ? 'live' : `${reasoning.data.nodes.length} nodes` },
      ...
      <aside className="nav-rail">
        <div className="brand-block">
          <div className="brand-mark">
            <img src={augurForgeLogo} alt="" aria-hidden="true" />
          </div>
          <div>
        ...
        <div className="rail-section">
          ...
          <button
            ...
            onClick={() =>
              void runCascade({
                mode: 'generate',
                intent: 'Use a financial report market risk section to build an interest-rate sensitivity and FX VaR sandbox',
              })
            }
            disabled={building}
          >
        ...
        <div className="rail-section">
          <span className="rail-label">Feature rooms</span>
          <a className="rail-action" href="/explainer.html">
            Explainer workbench
          </a>
          <a className="rail-action" href="/warroom.html">
            War Room console
          </a>
        </div>
          ...
          <div className="stage-column">
            ...
            <section className="chart-wrap" ref={chartWrapRef}>
              <div className="chart-title">
                ...
                {/* The fan/percentile-cone note describes the Monte Carlo chart only. Generated
                    models carry their own subtitle + provenance note, so this would be misleading. */}
                {!generatedBuild && (
