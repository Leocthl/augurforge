...
const SYSTEM =
  ...
  'For generated:black-scholes, generated:market-risk, or generated:sir, emit a declarative generatedSpec only: modelKind, title, subtitle, sliders, explainer, mapping. ' +
...
function mockModel(input: PipelineInput): GeneratedModelerResult {
  const generated =
    ...
    input.templateId === GENERATED_MARKET_RISK_ID ||
